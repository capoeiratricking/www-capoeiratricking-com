...
heroku apps:destroy staging-capoeiratricking-com --confirm staging-capoeiratricking-com
heroku apps:create staging-capoeiratricking-com
heroku domains:add staging.capoeiratricking.com --app staging-capoeiratricking-com
heroku git:remote -a staging-capoeiratricking-com -r staging-heroku
